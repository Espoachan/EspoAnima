...
#include "../../../../src/app/colorpicker/ColorPicker.h"
...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ColorPicker::*)(const QColor & )>(_a, &ColorPicker::colorSelected, 0))
            return;
    }
}
...
// SIGNAL 0
void ColorPicker::colorSelected(const QColor & _t1)
{
